...
impl Db {
    ...
    pub async fn create_interface(
        ...
        if let Some(ref remote) = self.remote_conn {
            ...
            {
                eprintln!(
                    "Warning: Failed to create interface on remote: {}",
                    e
                );
            }
        }
    ...
    pub async fn update_interface_counters(
        &self,
        id: i64,
        name: &str,
        rx: u64,
        ...
        if let Some(ref remote) = self.remote_conn {
            ...
            {
                eprintln!(
                    "Warning: Failed to update interface counters on remote: {}",
                    e
                );
            }
        }
    ...
    pub async fn update_interface_mac(
        &self,
        id: i64,
        name: &str,
        mac: &str,
        ...
        self.local_conn
            .execute(local_sql, (mac.to_string(), id))
            .await?;
        if let Some(ref remote) = self.remote_conn {
            ...
            {
                eprintln!(
                    "Warning: Failed to update interface MAC on remote: {}",
                    e
                );
            }
        }
    ...
    pub async fn update_interface_alias(
        &self,
        id: i64,
        name: &str,
        alias: &str,
        ...
        self.local_conn
            .execute(local_sql, (alias.to_string(), id))
            .await?;
        if let Some(ref remote) = self.remote_conn {
            ...
            {
                eprintln!(
                    "Warning: Failed to update interface alias on remote: {}",
                    e
                );
            }
        }
    ...
    pub async fn set_interface_active(
        ...
        if let Some(ref remote) = self.remote_conn {
            ...
            if let Err(e) = remote
                .execute(
                    remote_sql,
                    (active_val, name.to_string(), self.machine_id.clone()),
                )
                .await
            {
                eprintln!(
                    "Warning: Failed to set interface active status on remote: {}",
                    e
                );
            }
        }
    ...
    pub async fn remove_interface(&self, name: &str) -> Result<()> {
            ...
            self.get_interface(name).await?
        {
            ...
            for table in tables {
                let local_sql =
                    format!("DELETE FROM {} WHERE interface = ?", table);
                ...
                if let Some(ref remote) = self.remote_conn {
                    ...
                    let _ = remote
                        .execute(
                            &remote_sql,
                            (name.to_string(), self.machine_id.clone()),
                        )
                        .await;
                }
            }
            ...
            if let Some(ref remote) = self.remote_conn {
                ...
                {
                    eprintln!(
                        "Warning: Failed to remove interface on remote: {}",
                        e
                    );
                }
            }
    ...
    pub async fn rename_interface(
        ...
        if let Some((id, _, _, _, _, _, _, _, _)) =
            self.get_interface(old_name).await?
        {
            let local_sql = "UPDATE interface SET name = ? WHERE id = ?";
            self.local_conn
                .execute(local_sql, (new_name.to_string(), id))
                .await?;
            if let Some(ref remote) = self.remote_conn {
                ...
                {
                    eprintln!(
                        "Warning: Failed to rename interface on remote: {}",
                        e
                    );
                }
            }
